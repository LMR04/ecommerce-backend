        ...
        httpSecurity.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(request ->
                        request.requestMatchers(Constants.ENDPOINTS_PERMIT).permitAll()
                                .requestMatchers(Constants.ENDPOINTS_USER).hasRole("USER")
                                .requestMatchers(Constants.ENDPOINTS_ADMIN).hasRole("ADMIN")
                                .requestMatchers(Constants.ENDPOINTS_SUPERADMIN).hasRole("SUPERADMIN")
